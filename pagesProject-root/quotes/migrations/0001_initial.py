# Generated by Django 3.2.2 on 2021-05-30 08:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(choices=[('U', 'Urgent -1 week or less'), ('N', 'Normal - 2 to 4 weeks'), ('L', 'Low - Still Searching')], max_length=40)),
                ('jobfile', models.FileField(blank=True, upload_to='uploads/')),
                ('submitted', models.DateField(auto_now_add=True)),
                ('quotedate', models.DateField(blank=True, null=True)),
                ('quoteprice', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=5)),
